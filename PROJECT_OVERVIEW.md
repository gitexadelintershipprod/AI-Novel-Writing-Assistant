...
- **Qdrant/RAG**: `QDRANT_URL/API_KEY/COLLECTION/TIMEOUT_MS/UPSERT_MAX_BYTES`, `RAG_ENABLED`, `RAG_CHUNK_WORD_SIZE`, `RAG_CHUNK_OVERLAP_WORDS`, `RAG_VECTOR_CANDIDATES`, `RAG_KEYWORD_CANDIDATES`, `RAG_FINAL_TOP_K`, `RAG_WORKER_*`, `RAG_EMBEDDING_*`, `RAG_DEFAULT_TENANT`, `RAG_VERBOSE_LOG`, `RAG_GRAPH_ENABLED`, `NEO4J_URI/USER/PASSWORD/AUTH/TIMEOUT_MS`
