...
test("workspace diagnosis schema accepts canonical recommended action values", () => {
  const parsed = chapterEditorWorkspaceDiagnosisSchema.parse({
    cards: [{
      title: "ტემპი შენელებულია",
      problemSummary: "შუა მონაკვეთში სტატიკური აღწერა ჭარბობს.",
      whyItMatters: "ეს მთავარ კონფლიქტამდე მისვლას აყოვნებს.",
      ...
      title: "ანტაგონისტს სიღრმე აკლია",
      problemSummary: "ანტაგონისტის მოქმედება მხოლოდ ზეწოლას ეყრდნობა.",
      whyItMatters: "ეს კონფლიქტის დამაჯერებლობას ასუსტებს.",
      recommendedAction: "polish",
      recommendedScope: "selection",
      paragraphStart: 30,
      paragraphEnd: 36,
      severity: "medium",
      sourceTags: ["პერსონაჟი"],
    }, {
      title: "ემოციური დაძაბულობა სუსტია",
      problemSummary: "კულმინაციამდე ემოცია საკმარისად არ გროვდება.",
      whyItMatters: "ეს ფინალის ძალას ამცირებს.",
      recommendedAction: "emotion",
      recommendedScope: "selection",
      paragraphStart: 80,
      paragraphEnd: 84,
      severity: "high",
      ...
      title: "კონფლიქტი სუსტია",
      problemSummary: "პროტაგონისტი და მოწინააღმდეგე უშუალოდ არ უპირისპირდებიან ერთმანეთს.",
      whyItMatters: "ამის გამო სცენა ბრტყელი ჩანს.",
      recommendedAction: "conflict",
      recommendedScope: "selection",
      paragraphStart: 38,
      paragraphEnd: 45,
      severity: "medium",
      sourceTags: ["კონფლიქტი"],
    }],
    recommendedTask: {
      title: "მინიშნება გააძლიერე",
      summary: "პროტაგონისტმა შესაძლო გამოსავალი უფრო მკაფიოდ უნდა დაინახოს.",
