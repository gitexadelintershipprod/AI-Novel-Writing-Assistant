...
> = {
  list_worlds: {
    ...
    parserHints: {
      intent: "list_worlds",
      aliases: ["world list", "world library", "worlds", "世界观列表", "世界观库", "当前有哪些世界观"],
      phrases: ["List the worlds", "Which worlds are there now", "View the world list"],
  ...
  bind_world_to_novel: {
    ...
    parserHints: {
      ...
      aliases: ["Bind the world", "set novel world", "设置小说世界观", "将某个世界观设为当前小说的世界观", "把世界观绑定为当前小说世界观"],
      phrases: ["Set a world as this novel's world", "Bind a world as this novel's world"],
  ...
  unbind_world_from_novel: {
    ...
    title: "Unbind the novel's world",
    ...
    parserHints: {
      ...
      phrases: [
        "Do not use this world anymore",
        "Stop using this world for now",
        "Unbind this novel's world",
        "Cancel the current world",
      ],
      requiresNovelContext: true,
  ...
  rebuild_story_world_slice: {
    ...
    parserHints: {
      ...
      phrases: [
        "The world setting does not match the story",
        "The world slice is polluted with old vocabulary",
        "The world binding source is wrong",
        "Regenerate this book's world setting",
        "The slice is out of date",
      ],
      requiresNovelContext: true,
