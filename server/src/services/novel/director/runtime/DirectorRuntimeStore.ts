        ...
        events: hasStarted
          ...
          : [
            ...
            this.buildEvent({
              ...
              summary: input.summary ?? "The Auto-Director run entered the unified runtime.",
              occurredAt: now,
            }),
          ],
      };
    ...
    await this.mutateSnapshot(input.taskId, (snapshot) => ({
      ...
      events: [
        ...
        this.buildEvent({
          ...
          summary: input.summary ?? "Auto-Director continued using the current assets.",
          occurredAt: now,
          severity: "low",
          metadata: {
    ...
    await this.mutateSnapshot(input.taskId, (snapshot) => ({
      ...
      events: [
        ...
        this.buildEvent({
          ...
          novelId: input.novelId ?? snapshot.novelId ?? null,
          nodeKey: input.nodeKey,
          summary: `${input.label} failed: ${input.error}`,
          occurredAt: now,
          severity: "medium",
        }),
      ],
      ...
      return {
        ...
        events: [
          ...
          this.buildEvent({
            ...
            summary: input.analysis.interpretation?.summary ?? "Workspace analysis is complete.",
      ...
      return {
        ...
        events: [
          ...
          this.buildEvent({
            ...
            summary: `Auto-Director control policy switched to ${input.mode}.`,
