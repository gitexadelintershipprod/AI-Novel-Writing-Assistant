...
function buildFallbackAssessment(content: string): ChapterAcceptanceAssessmentOutput {
  ...
  return {
    status: "continue_with_risk",
    score,
    summary: "The draft was generated, but acceptance could not finish a structured judgment. The text is kept and marked for later review.",
    blockingIssues: [{
      severity: "medium",
      category: "mode_fit",
      code: "acceptance_gate_unavailable",
      evidence: "The chapter acceptance gate did not return a usable structured result.",
      fixSuggestion: "Keep the chapter text. You can rerun chapter review or a local rewrite later.",
    }],
    repairDirectives: [],
    missingObligations: [],
    repairability: "none",
    ...
    assetSyncRecommendation: {
      priority: "normal",
      reason: "The draft was saved. Consider running chapter review or asset sync later.",
