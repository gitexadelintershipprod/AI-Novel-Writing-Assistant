...
export default function ChapterManagementTab(props: ChapterTabViewProps) {
  ...
  const queueFilters = useMemo(
    () => ([
      ...
      { key: "review", label: "To be repaired" },
  ...
  return (
    <div className="space-y-4">
      <DirectorTakeoverEntryPanel
        ...
        description="The AI will first determine whether there are currently active batches, checkpoints, or executable chapter ranges, and then decide whether to restore the current batch or open a new batch according to your choice."
      ...
      <CardHeader className="gap-3 rounded-2xl bg-muted/20 px-5 py-4">
        <div className="flex flex-col gap-3 xl:flex-row xl:items-start xl:justify-between">
          ...
          <Button onClick={onCreateChapter} disabled={isCreatingChapter}>
            {isCreatingChapter ? "Creating..." : "Create new chapter"}
          </Button>
        </div>
      </CardHeader>
          ...
          <div className="h-full min-h-0 xl:sticky xl:top-4">
            ...
            >
              <TabsList className="grid h-auto w-full shrink-0 grid-cols-3 rounded-xl bg-muted/50 p-1.5">
                ...
                <TabsTrigger value="agent" className="rounded-lg px-3 py-2 text-sm">AI execution desk</TabsTrigger>
              </TabsList>
