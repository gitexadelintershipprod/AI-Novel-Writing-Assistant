        ...
        <div className={`space-y-3 border-l p-3 ${minHeightClassName}`}>
          ...
          {selectedText ? (
            <div className="rounded-md border bg-muted/20 p-2 text-xs text-muted-foreground">
              <div className="mb-1 font-medium">Currently selected content (will be used for precise optimization)</div>
              <div className="max-h-24 overflow-auto whitespace-pre-wrap">{selectedText}</div>
            </div>
          ) : (
            <div className="text-xs text-muted-foreground">Only full-text optimization is supported when content is not selected.</div>
          )}
