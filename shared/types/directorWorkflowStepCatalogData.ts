...
export const WORKFLOW_DISPLAY_STAGES: readonly {
  ...
  { key: "story_planning", label: "Story planning" },
  { key: "world_setup", label: "World setup" },
  { key: "character_setup", label: "Character setup" },
  { key: "volume_strategy", label: "Volume strategy" },
...
export const WORKFLOW_STEP_CATALOG: readonly WorkflowStepCatalogEntry[] = [
  ...
  },
  {
    ...
    label: "Sync chapter execution contracts",
    targetType: "novel",
...
export const WORKFLOW_CHECKPOINT_CATALOG: readonly WorkflowCheckpointCatalogEntry[] = [
  ...
  },
  {
    ...
    workflowStage: "character_setup",
    tab: "character",
    label: "Character setup needs confirmation",
    approvalPoint: "character_setup_ready",
    defaultProgress: 0.52,
  },
  {
    ...
    workflowStage: "volume_strategy",
    tab: "outline",
    label: "Volume strategy is ready",
    approvalPoint: "volume_strategy_ready",
    defaultProgress: 0.62,
  },
  {
    ...
    waitingApprovalLabel: "Beat/chapter split is done; writing can start",
    pausedLabel: "Auto-run is paused",
    approvalPoint: "structured_outline_ready",
    defaultProgress: 0.9,
  },
  {
    ...
    workflowStage: "auto_director",
    tab: "pipeline",
    label: "Step generated; waiting for review",
    waitingApprovalLabel: "This step is done; review it before continuing",
    pausedLabel: "Step-by-step collaboration is paused",
    approvalPoint: null,
    defaultProgress: 0.5,
  },
  {
    ...
    workflowStage: "quality_repair",
    tab: "pipeline",
    label: "Quality repair needs attention",
  ...
  },
  {
    ...
    workflowStage: "quality_repair",
    tab: "pipeline",
    label: "Director main flow is complete",
    approvalPoint: null,
    defaultProgress: 1,
  },
  {
