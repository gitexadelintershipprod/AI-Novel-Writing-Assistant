...
const DIRECTOR_NODE_DISPLAY_LABELS: Record<string, string> = {
  candidate_generation: "Generate the book direction",
  candidate_refine: "Refine the book direction",
  candidate_patch: "Patch the book direction",
  candidate_title_refine: "Refine the title",
  novel_create: "Create the novel project",
  takeover_execution: "Take over an existing project",
  story_macro: "Story planning",
  story_macro_phase: "Story planning",
  book_contract: "Book contract",
  book_contract_phase: "Book contract",
  world_setup: "World setup",
  world_setup_phase: "World setup",
  character_setup: "Cast setup",
  character_setup_phase: "Cast setup",
  volume_strategy: "Volume strategy",
  volume_strategy_phase: "Volume strategy",
  "volume_strategy.volume_generation": "Generate the volume strategy",
  structured_outline: "Chapter split and task sheets",
  structured_outline_phase: "Chapter split and task sheets",
  "structured_outline.beat_sheet": "Generate the beat sheet",
  "structured_outline.chapter_list": "Generate the chapter list",
  "structured_outline.chapter_detail_bundle": "Prepare chapter task sheets",
  "structured_outline.chapter_sync": "Sync chapter execution resources",
  "book.candidate.generate": "Generate the book direction",
  "book.candidate.refine": "Refine the book direction",
  "book.candidate.patch": "Patch the book direction",
  "book.candidate.title_refine": "Refine the title",
  "book.project.create": "Create the novel project",
  "workflow.takeover.execute": "Take over an existing project",
  "story.macro.plan": "Story planning",
  "book.contract.create": "Book contract",
  "character.cast.prepare": "Cast setup",
  "volume.strategy.plan": "Volume strategy",
  "chapter.task_sheet.plan": "Chapter split and task sheets",
  chapter_execution: "Chapter execution flow",
  chapter_execution_node: "Chapter execution flow",
  chapter_quality_review: "Chapter quality review",
  chapter_quality_review_node: "Chapter quality review",
  chapter_repair: "Chapter issue repair",
  chapter_repair_node: "Chapter issue repair",
  quality_repair: "Chapter quality fixes",
  chapter_state_commit: "Update chapter status",
  chapter_state_commit_node: "Update chapter status",
  payoff_ledger_sync: "Synchronous foreshadowing and reader commitment",
  payoff_ledger_sync_node: "Synchronous foreshadowing and reader commitment",
  character_resource_sync: "Synchronize role status",
  character_resource_sync_node: "Synchronize role status",
  "chapter.draft.write": "Chapter text generation",
  "planner.chapter.plan": "Chapter planning",
  "novel.chapter.writer": "Chapter text generation",
  "audit.chapter.light": "Basic quality inspection",
  "audit.chapter.full": "Complete quality check",
  "novel.review.patch": "Partial text repair",
  "style.detection": "style check",
  "style.rewrite": "style adjustment",
  "novel.payoff_ledger.sync": "Foreshadowing and reader commitment are synchronized",
  "novel.characterDynamics.chapterExtract": "Role dynamic synchronization",
  "novel.character_resource.extract_updates": "Role resource synchronization",
  "state.snapshot.extract": "Chapter status synchronization",
  "chapter.quality.review": "Chapter quality review",
  "chapter.draft.repair": "Chapter issue repair",
  "chapter.state.commit": "Update chapter status",
  "payoff.ledger.sync": "Synchronous foreshadowing and reader commitment",
  "character.resource.sync": "Synchronize role status",
  "planner.replan": "Adjust the plan for subsequent chapters",
};
...
export function getDirectorNodeDisplayLabel(input: {
  ...
  return input.fallback ?? "AI advancement steps";
}
